    ...
    <motion.div variants={ANIM} initial="hidden" animate="visible" className="space-y-6">
      ...
      <motion.div variants={ITEM} className="glass-card-solid p-6 text-center">
        ...
        <div className="flex items-center justify-center gap-4 mt-3 text-xs text-muted-foreground">
          <span className="flex items-center gap-1"><MapPin className="h-3 w-3" /> Cairo, Egypt</span>
          <span className="flex items-center gap-1"><User className="h-3 w-3" /> 450 students</span>
        </div>
      </motion.div>

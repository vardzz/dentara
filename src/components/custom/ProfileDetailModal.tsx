                    ...
                    <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:gap-6">
                      ...
                      <div className="flex shrink-0 flex-wrap gap-2 sm:ml-auto sm:justify-end">
                        <div className="rounded-full border border-slate-200/80 bg-white/75 px-3 py-2 text-xs font-semibold text-slate-600 shadow-[0_10px_30px_-16px_rgba(10,31,68,0.25)]">
                          {isStudent ? selectedUser.yearLevel || 'Year not specified' : 'Patient profile'}
                        </div>
                        <div className="rounded-full border border-[#138b94]/15 bg-[#138b94]/8 px-3 py-2 text-xs font-semibold text-[#0a1f44] shadow-[0_10px_30px_-16px_rgba(19,139,148,0.3)]">
                          {isStudent ? getPrimarySpecialty(selectedUser.cases) : selectedUser.concern}
                        </div>
                      </div>
                    </div>
